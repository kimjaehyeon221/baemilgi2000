...
export const styles = StyleSheet.create({
  ...
  questSectionLabel: { color: C.ink, fontSize: 12, fontFamily: headlineFont, fontWeight: '900', letterSpacing: 0.4, marginBottom: 11, marginTop: 2 },
  ...
  milestoneCopy: { color: C.muted, fontSize: 10, fontFamily: labelFont, fontWeight: '800', marginTop: 3 },
  ...
  statLabel: { color: C.blue, fontSize: 10, fontFamily: labelFont, fontWeight: '900', letterSpacing: 0.7 },
