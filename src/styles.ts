...
export const styles = StyleSheet.create({
  ...
  introMeta: { color: C.faint, fontSize: 11, lineHeight: 17, maxWidth: 298, marginTop: 3 },
  ...
  setupBody: { flex: 1, justifyContent: 'flex-start', paddingTop: 58, paddingBottom: 18 },
  setupScroll: { paddingTop: 40, paddingBottom: 24 },
  question: { color: C.text, fontSize: 32, lineHeight: 38, fontWeight: '800', letterSpacing: -1.35, maxWidth: 298 },
  copy: { color: C.muted, fontSize: 14, lineHeight: 22, marginTop: 14, maxWidth: 298 },
