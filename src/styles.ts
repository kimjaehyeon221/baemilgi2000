...
export const styles = StyleSheet.create({
  ...
  cell: { width: '23%', minHeight: 58, borderWidth: 0, backgroundColor: C.panelLift, paddingVertical: 9, paddingHorizontal: 8, justifyContent: 'space-between' },
